...
class ActivegymerController extends Controller
{
    /**
    ...
    {
        return view('superadminbackend.active_gymer.index');
    }
        ...
        if(!empty($posts))
        {
            foreach ($posts as $key=>$post)
            {
                ...
                <div class="text-center">                   
                    ...
                    <form action="'.route('superadmin.active_gymer.destroy', [$post->id]).'"
                            method=POST
                            class="d-inline-block inactive_gymer"
                            title=" Inactive Gymer"
                            data-type="inactive_gymer">
                        <input type="hidden" name="_token" value="'.csrf_token().'">
                        <input name="_method" type="hidden" value="DELETE">
                        <button class="btn  btn-outline-danger" data-toggle="tooltip" data-placement="top" title=" Inactive Gymer" type="submit"><i class="fas fa-exchange-alt"></i></button>
                    </form>
    ...
    public function edit(Request $request)
    {
        ...
        return view('superadminbackend.active_gymer.create-edit',compact('data_list','payments'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $active_gymer)
    {
    ...
    public function destroy(Request $request)
    {
        ...
        $data = User::find($request->active_gymer);
        ...
        $notices = array(
            ...
            'message' => $data->name.', has been Inactive.'
        );

  ...
  $(document).ready(function(){
    ...
    function fill_datatable()
    {
      var dataTable = $('#list-table').DataTable({
        ...
        "ajax":{
            "url": "{{route('superadmin.groupdiscount.show','dataTable')}}",
            "dataType": "json",
            "type": "GET",
            "data":{
        ...
        "columns": [
          ...
          { data: 'no_gymer',title: 'No. Gymer', orderable: true,searchable: true},
      ...
      $('#formSubmit').on('click', function(){
        var datastring = $("#formData").serializeArray(),
            url = "{{ route('superadmin.groupdiscount.store') }}";
...
$('#modelBtn').on('click', function(){
  var url = "{{ route('superadmin.groupdiscount.create') }}";
  modalAppend(url);
});

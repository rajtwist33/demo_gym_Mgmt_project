    ...
    function fill_datatable()
    {
      var dataTable = $('#list-table').DataTable({
        ...
        "columns": [
          ...
          { data: 'amount',title: 'Actual Amount', orderable: true,searchable: true},
          { data: 'force_discount',title: 'Discount (%)', orderable: true,searchable: true},
          { data: 'total',title: 'Paid Amount', orderable: true,searchable: true},

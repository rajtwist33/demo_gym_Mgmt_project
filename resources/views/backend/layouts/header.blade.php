 {{-- Navbar --}}
  <nav class="main-header navbar navbar-expand navbar-light  navbar-dark ">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <h4 class="text-warning mt-2 ml-2">Admin</h4>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link"  href="#" role="button" data-toggle="modal" data-target="#paymentalert">
          <i class="far fa-bell"></i><sup class=" "> <button class="btn btn-sm btn-danger">{{ $count_alert }}</button></sup>
        </a>
      </li>
      <li class="nav-item">
